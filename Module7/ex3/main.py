...
def main():
    try:
        ...
        _ = [fantasy_cards.create_creature('dragon'), fantasy_cards.create_creature('goblin'), fantasy_cards.create_spell('fireball'), fantasy_cards.create_artifact('mana_ring')]
