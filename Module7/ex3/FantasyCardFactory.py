...
random_rarity_list = ["Common", "Uncommon", "Rare",
...
random_creature_names = ["Goblin", "Elf",
                         "Dragon", "Knight"]
random_spell_names = ["Fireball", "Lightning Bolt", "Frost Nova"]
random_artifact_names = ["Sword of Power", "Shield of Resilience",
                         "Amulet of Wisdom"]
...
class FantasyCardFactory(CardFactory):
    ...
    def create_creature(self, name_or_power=None):
        if isinstance(name_or_power, str):
            ...
            return CreatureCard(
                name_or_power,
                random.choice(random_cost_list),
                random.choice(random_rarity_list),
                random.choice(random_attack_power_list),
                random.choice(random_health_list),
            )
    ...
    def create_spell(self, name_or_power=None):
        if isinstance(name_or_power, str):
            ...
            return SpellCard(
                ...
                random.choice(random_cost_list),
                random.choice(random_rarity_list),
                random.choice(random_effect_types),
            )
        elif isinstance(name_or_power, int):
            self.cards_created += 1
            self.cards_types["spell"] += 1
    ...
    def create_artifact(self, name_or_power=None):
        if isinstance(name_or_power, str):
            ...
            return ArtifactCard(
                ...
                random.choice(random_cost_list),
                random.choice(random_rarity_list),
                random.choice(random_durability_list),
                random.choice(random_effect_list),
            )
        elif isinstance(name_or_power, int):
            self.cards_created += 1
            self.cards_types["artifact"] += 1
        ...
        for card in range(size):
            ...
            if card_type == "creature":
                ...
                deck["creature"].append(
                    self.create_creature(random.choice(random_creature_names))
                )
            elif card_type == "spell":
                self.cards_created += 1
                self.cards_types["spell"] += 1
                deck["spell"].append(
                    self.create_spell(random.choice(random_spell_names))
                )
            else:
                self.cards_created += 1
                self.cards_types["artifact"] += 1
                deck["artifact"].append(
                    self.create_artifact(random.choice(random_artifact_names))
                )
        return deck
