...
def main():
    try:
        ...
        elite_card = EliteCard(name="Arcane Warrior", cost=4, rarity="Epic", attack_power=5, defense=5, magic_power=6)
        card = EliteCard(name="Enemy", cost=2, rarity="Common", attack_power=3, defense=2, magic_power=1)
